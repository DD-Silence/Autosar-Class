...
{
    public partial class AsrLinFrame : IAsrIdentifier
    {
        public LINUNCONDITIONALFRAME Model { get; }
        ...
        public AsrLinFrame(LINUNCONDITIONALFRAME model, AsrPathReferenceManager pathManager)
        {
            Model = model;
